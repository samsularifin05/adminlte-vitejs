...
var Route = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react2.default.createElement(context.Consumer, null, function(context$$1) {
      ...
      return import_react2.default.createElement(context.Provider, {
        value: props
      }, children && !isEmptyChildren(children) ? children : props.match ? component ? import_react2.default.createElement(component, props) : render2 ? render2(props) : null : null);
    });
  };
  return Route2;
}(import_react2.default.Component);
...
function withRouter(Component2) {
  ...
  var C = function C2(props) {
    ...
    return import_react2.default.createElement(context.Consumer, null, function(context$$1) {
      !context$$1 ? true ? invariant(false, "You should not use <" + displayName + " /> outside a <Router>") : invariant(false) : void 0;
      return import_react2.default.createElement(Component2, _extends({}, remainingProps, context$$1, {
...
if (true) {
  toType = import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.object]);
  innerRefType = import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.func, import_prop_types3.default.shape({
